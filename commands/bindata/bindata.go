...
func TemplatesServer_resources_apiTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "../templates/server_resources_api.tmpl", size: 1222, mode: os.FileMode(420), modTime: time.Unix(1458728343, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func TemplatesServer_resources_interfaceTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "../templates/server_resources_interface.tmpl", size: 1150, mode: os.FileMode(420), modTime: time.Unix(1458728369, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
