...
func TemplatesOauth2_middlewareTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "../templates/oauth2_middleware.tmpl", size: 1703, mode: os.FileMode(420), modTime: time.Unix(1463714685, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func TemplatesServer_resources_apiTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "../templates/server_resources_api.tmpl", size: 1177, mode: os.FileMode(420), modTime: time.Unix(1463717118, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func TemplatesServer_resources_interfaceTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "../templates/server_resources_interface.tmpl", size: 1127, mode: os.FileMode(420), modTime: time.Unix(1463717126, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
