-- Generated by lua-capnproto 0.1.3-1 on Mon Jan 29 12:08:26 2018
...
_M.User = {
    id = "17872531679707738225",
    displayName = "tarantool/handlers/schemas/User.capnp:User",
    dataWordCount = 0,
    pointerCount = 2,
    discriminantCount = 0,
    ...
    parse_struct_data = function(p32, data_word_count, pointer_count, header,
        ...
        if off and num then
            -- dataWordCount + offset + pointerSize + off
            local p8 = ffi_cast(pint8, p32 + (0 + 1 + 1 + off) * 2)
